---
title: "Explore Environmental Variables"
author: "Rose Andrew"
date: "15 June 2019"
output:
...
For bivariate analyses, this has already been implemented in the 'modified.ttest' functions in the 'SpatialPack' package (Dutilleul et al. 1993). 
...
# heatmap(mymatrix,Rowv=NA,Colv=NA,scale="none")

heatmap.2(mymatrix2,dendrogram = "none",scale="none",trace="none", density="none",
          Rowv=F,Colv=F,col=rev(heat.colors(nrow(env)*nrow(env))))
